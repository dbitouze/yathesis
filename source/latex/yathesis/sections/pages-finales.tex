...
\begin{docCommand}[doc description=\mandatory]{backmatter}{}
  ...
  de la commande usuelle \docAuxCommand{backmatter} de la
  \Class{book}\nofrontmatter.
\end{docCommand}
...
\docAuxCommand{printglossary} et \docAuxCommand{printglossaries} qui produisent
...
\Package*{index} dont le lecteur est, dans cette section, supposé connaître le
fonctionnement\footnote{Sinon, cf. par exemple \cite{en-ligne7}.}.
