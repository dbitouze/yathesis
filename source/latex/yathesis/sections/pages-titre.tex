...
\changes{v0.99g}{2014/07/13}{La personnalisation des pages de titre (cadre
  autour du tire, page de 1\iere{} de couverture ou pas) peut se faire en
  option de \protect\docAuxCommand{maketitle}}%
%
...
\begin{landscape}
  \begin{figure}[htb]
    ...
    \begin{subfigure}[b]{.45\linewidth}
      \centering%
      \fbox{\includegraphics[page=5,width=\linewidth-2\fboxsep-2\fboxrule]{master-slaves-files-sample/these}}
