...
\end{docKey}
%
\begin{docKey}{nolaboratorynamelink}{=\docValue{true}\textbar\docValue{false}}{par défaut
...
\changes{v0.99f}{2014/07/11}{Possibilité de spécifier des directeurs de thèses
  non membres du jury}
...
\changes{v0.99f}{2014/07/11}{Possibilité de spécifier si une personne est un
  homme ou une femme}
