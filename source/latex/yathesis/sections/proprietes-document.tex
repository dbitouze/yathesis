...
Ce chapitre liste les commandes et options permettant de \emph{préparer} les
...
\section{Où préparer les caractéristiques du document ?}
...
\item\label{propertiesfile} dans un fichier dédié, à nommer
  ...
  \begin{dbwarning}{Fichier de caractéristiques à ne pas importer}{}
