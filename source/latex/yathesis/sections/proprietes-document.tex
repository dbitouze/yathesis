...
Les directeurs de thèse peuvent être ou ne pas être membres du jury. Les
premiers sont définis au moyen des commandes \refCom{supervisor},
\refCom{cosupervisor} et \refCom{comonitor} ci-dessous, et les seconds au moyen
de variantes étoilées de ces commandes.
...
\begin{docCommand}{cosupervisor*}{\oarg{précision(s)}\marg{prénom}\marg{nom}}
  Cette commande définit un co-directeur de la thèse (non membre du jury).
\end{docCommand}
...
\begin{docCommand}{comonitor*}{\oarg{précision(s)}\marg{prénom}\marg{nom}}
  Cette commande définit un co-encadrant de la thèse (non membre du jury).
\end{docCommand}
