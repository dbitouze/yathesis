...
Le fait qu'une personne ait pour option ×female×\footnote{Ou, de façons
  équivalentes, \protect\lstinline|male=false| ou
  \protect\lstinline|female=true|.} n'a pour effet que d'accorder en genre
féminin un certain nombre de mots clés de la \yatcl{} (\enquote{directrice} au
lieu \enquote{directeur}, \enquote{chargée de recherche} au lieu
\enquote{chargé de recherche}, etc.).
