...
\item directement dans le fichier (maître) de la thèse :
  ...
  \item soit dans le corps ;
    \begin{dbwarning}{Propriétés à saisir \emph{avant}
  ...
  \end{dbwarning}
  \end{itemize}
\item\label{propertiesfile} dans un fichier dédié, à nommer
  \file{\propertiesfile} et à placer dans un sous-dossier à nommer
