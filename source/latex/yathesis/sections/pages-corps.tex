...
\begin{dbremark}{Variante étoilée de la commande \protect\docAuxCommand*{chapter} modifiée}{}
  ...
  \item les (sous-(sous-))sections du chapitre sont à créer avec les versions
    \emph{non} étoilées des commandes correspondantes : \docAuxCommand{section},
...
\begin{dbexample}{Introduction}{}
  ...
  \docAuxCommand{chapter} figure sous sa forme étoilée.
  %
...
remplaçant fortement conseillé de \hologo{BibTeX}. Leur fonctionnement est,
