...
\begin{dbfaq}{Pourquoi mes signes de ponctuation ne sont pas précédés
  ...
  \tcblower
  %
  Il suffit de modifier le lieu de saisie de ces
  caractéristiques\footnote{Cf. \vref{sec:lieu-de-saisie}.} :
  \begin{itemize}
  \item soit dans le \emph{corps} du fichier (maître) de la thèse\footnote{Mais
      cf. alors \vref{wa:avant-maketitle}.}, et \emph{pas} dans son
    \emph{préambule} ;
