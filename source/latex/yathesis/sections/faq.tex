...
\begin{dbfaq}{Le \acrshort{pdf} de mon mémoire n'est pas valide au yeux du
  ...
  \tcblower
  %
  Il devrait suffire d'installer le logiciel libre \program{PDFtk}\footnote{Ce
  ...
  \acrshort{pdf} original du mémoire étant \file{these.pdf} : le fichier
  \file{these-valide.pdf} généré devrait être valide.
