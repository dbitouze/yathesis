...
\begin{dbfaq}{Pourquoi les signets des glossaire, listes d'acronymes et de
  ...
  régler le problème, il devrait donc suffire de ne pas explicitement demander
  à ce que ce soit le cas, en \emph{ne} passant \emph{pas} l'option
  \docAuxKey*{toc} au \Package{glossaries}.
\end{dbfaq}
