...
\begin{dbfaq}{Pourquoi les signets des glossaire, listes d'acronymes et de
    symboles apparaissent en double ?}{}
  Les signets des glossaire, listes d'acronymes et de symboles apparaissent en
  double. Comment éviter cela ?%
  \tcblower
  %
  La \yatcl{} fait figurer les glossaire, listes d'acronymes et de symboles
  à la fois dans la table des matières et dans les signets. Il devrait donc
  suffire de ne pas explicitement demander à ce que ce soit le cas, en
  \emph{ne} passant \emph{pas} l'option \docAuxKey*{toc} au
  \Package{glossaries}.
\end{dbfaq}
