...
\begin{dbremark}{Commande \protect\docAuxCommand{frontmatter} à ne pas utiliser}{nofrontmatter}
  ...
  loin que, au contraire, les autres commandes analogues de la \Class{book} :
...
(cf. \vref{wa:frenchabstract}), une préface, un avant-propos, etc. Ceux-ci sont
à considérer comme des chapitres \enquote{ordinaires} et doivent donc être
introduits au moyen de la commande usuelle \docAuxCommand{chapter}, sous sa
forme \emph{non} étoilée : puisqu'ils seront situés dans la partie liminaire du
mémoire, ces chapitres seront automatiquement \emph{non} numérotés.
