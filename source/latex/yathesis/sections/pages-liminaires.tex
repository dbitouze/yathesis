...
\Package{glossaries}\footnote{Dans ses versions à partir de la \texttt{4.0} en
  date du \formatdate{14}{11}{2013}.} \phrase{dont le fonctionnement est, dans
  cette section, supposé connu du lecteur\footnote{Sinon, cf. par exemple
    \cite{en-ligne7}.}} :
\begin{itemize}
...
des acronymes\footnote{Les commandes \docAuxCommand{printglossary} et
  ...
  \begin{itemize}
  \item si elles sont \emph{communes}, \emph{la} liste résultante en annexe ;
  \item si elles sont \emph{distinctes} :
    ...
    \item la liste des termes du glossaire en pages finales.
    \end{enumerate}
  \end{itemize}
