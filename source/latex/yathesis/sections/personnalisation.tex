...
\begin{dbwarning}{Par défaut, documents en version intermédiaire}{}
  ...
  par défaut en version \emph{intermédiaire}\footnote{En effet, un mémoire de
    thèse est l'essentiel du temps en version intermédiaire, les versions
    à soumettre et finale n'étant à produire qu'exceptionnellement, en toute
    fin de rédaction.}.
\end{dbwarning}
