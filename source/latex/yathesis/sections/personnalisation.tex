...
telles que traduites par la \yatcl{}. Il s'agit en fait des traductions
fournies par les modules \package{frenchb} et \package{english} du
\Package{babel}, à l'exception de l'expression des tableaux flottants qui, en
français, est \enquote{Tableau} au lieu de \enquote{Table}.
