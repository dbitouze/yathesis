...
{%
  \tcbset{before lower=\vspace*{\baselineskip}\par}
\begin{docKey}{frametitle}{=\docValue{none}\textbar\docValue{shadowbox}\textbar\docValue{ovalbox}\textbar\marg{autre}}{pas de valeur par défaut, pas de valeur initiale}
...
\begin{dbexample}{Cadre personnalisé autour du titre de la thèse}{}
  L'exemple suivant montre comment personnaliser le cadre autour du titre de la
  thèse, de sorte à ce qu'il soit sur fond gris.
\begin{preamblecode}
\yadsetup{frametitle={colback=lightgray}}
\end{preamblecode}
\end{dbexample}
