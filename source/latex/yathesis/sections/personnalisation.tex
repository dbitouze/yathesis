...
\begin{docKey}{titlesec}{=\marg{option(s)}}{pas valeur par défaut, initialement
    vide}
  \changes{v0.99j}{2014/07/18}{Clé \protect\refAux{titleps} remplacée par (et
    alias de) la clé \protect\refKey{titlesec}}% ^^A
  Cette option permet de passer une ou plusieurs \meta{option(s)} au
  \Package{titlesec}.
\end{docKey}
...
\enquote{Tableau}).% ^^A
\changes*{v0.99i}{2014/07/17}{Les légendes des tableaux flottants sont
