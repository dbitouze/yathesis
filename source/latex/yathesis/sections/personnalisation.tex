...
\begin{docKey}{version}{=\docValue{inprogress}\textbar\docValue{inprogress*}\textbar\docValue{submitted}\textbar\docValue{submitted*}\textbar\docValue{final}\textbar\docValue{draft}}{pas
    ...
    \item[\docValue{submitted}.] Cette valeur produit une version du document
      ...
      \item \changes*{v0.99f}{2014/07/11}{Date de soutenance et composition du
          jury absentes des pages de titre (et non obligatoires) en versions
          \enquote{à soumettre}}% ^^A
        % ^^A
...
Le \vref{tab:expressions-standard} liste les expressions standard de \LaTeX{}
fournies par la \yatcl{}. Il s'agit en fait des traductions fournies par les
modules \package{frenchb} et \package{english} du \Package{babel},
à l'exception de l'expression des tableaux flottants qui, en français, est
\enquote{Tableau} au lieu de \enquote{Table}.
