...
%
\changes{v0.99o}{2016-09-29}{Nouvelle option de classe \refKey{localtocs}
...
{%
  ...
  \begin{docKey}[][doc
    new=2016-09-29]{localtocs/depth}{=\docValue{section}\textbar\docValue{subsection}\textbar\docValue{subsubsection}\textbar\docValue{paragraph}\textbar\docValue{subparagraph}}{par
...
\begin{docCommand}[doc new=2016-09-29]{stoplocaltocs}{}
  \index{table des matières!locale}%
...
%
\changes{v0.99o}{2016-09-29}{Nouvelle option de classe \refKey{localbibs}
  permettant de faire automatiquement finir les chapitres par leurs
  bibliographies locales}%

\begin{docKey}[][doc new=2016-09-29]{localbibs}{}{pas de valeur par défaut, pas
    de valeur initiale} 
