...
\index{caractéristiques de la thèse}%
...
\begin{docCommand}[doc description=\mandatory]{author}{\oarg{adresse
  ...
  \index{caractéristiques de la thèse!auteur}%
  \index{auteur}%
  ...
  \begin{dbwarning}{Format des prénom et nom de l'auteur}{}
    ...
    \item les éventuels accents figurent dans les \meta{prénom} et
      \meta{nom};
    \item \index{caractéristiques de la thèse!auteur!capitales}%
      \index{capitales}%
      \index{majuscules}%
      % \index{auteur de la thèse!majuscules|see{auteur de la thèse!capitales}}%
...
\begin{docCommand}[doc description=\mandatory]{title}{\oarg{titre dans la langue
  ...
  \index{caractéristiques de la thèse!titre}%
  \index{titre}%
...
\begin{docCommand}{subtitle}{\oarg{sous-titre dans la langue
  ...
  \index{caractéristiques de la thèse!sous-titre}%
  \index{sous-titre}%
  % \index{titre de la thèse!sous-titre|see{sous-titre de la thèse}}%
...
\begin{docCommand}[doc description=\mandatory]{academicfield}{\oarg{discipline dans la langue
  ...
  \index{caractéristiques de la thèse!discipline}%
  \index{discipline}%
...
\begin{docCommand}{speciality}{\oarg{spécialité dans la langue
  ...
  \index{caractéristiques de la thèse!spécialité}%
  \index{spécialité}%
...
\begin{dbremark}{Titre, sous-titre, champ disciplinaire et spécialité dans la
  ...
  \index{caractéristiques de la thèse!en langue secondaire}%
...
%   \begin{bodycode}[title=Préparation du titre (p. ex. dans le \File{\characteristicsfile})]
...
\begin{docCommand}{ordernumber}{\oarg{numéro d'ordre}}
  ...
  du mémoire\footnote{Première de couverture s'il y a, page de titre en langue
