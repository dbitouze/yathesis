...
\index{table des matières!entrée en double}%
...
\begin{dbfaq}{Comment supprimer la bibliographie des sommaire, table des
    matières et signets ?}{}
  \index{table des matières!bibliographie}%
...
\begin{dbfaq}{Comment affecter des profondeurs différentes aux signets et à la
    table des matières ?}{}
  \index{table des matières!profondeur!signet}%
...
\begin{dbfaq}{Dans la table des matières, des numéros de pages débordent dans
    la marge de droite}{}
  \index{table des matières!débordement dans la marge}%
