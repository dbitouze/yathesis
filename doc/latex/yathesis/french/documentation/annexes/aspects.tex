...
\item À l'exception de la 4\ieme{} de
  ...
  \zvref{cha-pages-de-titre,cha-liminaires,cha-corps,cha-annexes} commencent
...
\item Les \glspl{titrecourant} sont constitués, en marges  :
  ...
  \item dédiées :
    ...
    %résumés (cf. \zvref{rq:titrecourant}) ;
...
\item
  ...
  \item de la partie corps\footnote{Sauf ceux créés avec la forme étoilée de la
      commande \docAuxCommand{chapter} (cf. \zvref{sec-chap-non-numer}).}, alors
