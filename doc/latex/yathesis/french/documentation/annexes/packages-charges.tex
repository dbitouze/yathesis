...
On a vu \zvref{sec-options-passer-aux} que, pour plusieurs de ses
...
\item[\package{titlesec} :] %
  ...
  %     (cf. \zvref{sec-chapitres-numerotes}) et
...
\item[\package{hyperref} :]\index{lien hypertexte} \changes*{v0.99h}{2014-07-14}{Packages
  ...
  \item[options par défaut :]\leavevmode{}
    ...
    \end{itemize}
  \end{description}
\item[\package{glossaries-extra} :]\index{glossaire}\index{acronyme}\index{symbole!liste
