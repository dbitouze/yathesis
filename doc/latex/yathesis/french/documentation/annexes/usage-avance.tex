...
On a vu \zvref{sec-comm-oblig} que la \yatCl{} considère comme
...
derniers figure à la 1\iere{} colonne du \zvref{tab-no-warnings}.
\begin{table}[ht]
  \centering
...
\item[soit individuelle] au moyen des clés listées à la 2\ieme{} colonne du
  \zvref{tab-no-warnings} et dont le rôle est précisé ci-après.
