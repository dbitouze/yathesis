...
On a vu \zvref{rq-acronymes} que si un institut (par exemple) doit figurer
sous la forme d'un acronyme, on aura intérêt à ne pas le saisir tel
quel, mais à recourir aux fonctionnalités du
\Package{glossaries-extra}\footnote{Cf. \zvref{sec-sigl-gloss-nomencl} pour
...
\begin{dbremark}{Acronymes et élisions automatiques}{}
  Les \zvref{wa-elision-disclaimer,wa-elision-separateurs} ont déjà
...
\item créer un fichier \enquote{parent}\footnote{Dans les spécimens et canevas
    de thèse fournis avec la classe, décrits \zvref{cha-specimen-canevas}, le
...
\item stocker le contenu des chapitres, chacun dans un fichier
  ...
  % classe, décrit \zvref{cha-specimen-canevas}, l'inclusion des fichiers
...
\item si la thèse se présente en plusieurs grandes parties, chacune
  ...
  \zvref{ex-avec-parties}).
\end{itemize}
%
Les \zvref{ex-sans-parties,ex-avec-parties} illustrent l'usage de
...
\end{dbexample}
%
Le canevas \enquote{en arborescence}, détaillé \zvref{sec-canevas-arborescence},
