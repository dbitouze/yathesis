...
\begin{dbfaq}{Est-il possible d'obtenir des \glsplural{titrecourant} distincts
  ...
  %
  Les titres des chapitres sont reproduits en \glsplural{titrecourant} et,
  lorsque les titres de certains chapitres sont si longs qu'il débordent de
  l'entête, je peux recourir à l'argument optionnel de la commande
  \docAuxCommand{chapter} pour que ceux-ci soient y remplacés par des versions
  alternatives \enquote{courtes}.
