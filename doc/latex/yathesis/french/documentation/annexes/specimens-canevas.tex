...
\item[\enquote{en arborescence} :]%
  ...
  le source est scindé en fichiers parent et enfants\footnote{Comme cela est en
    général recommandé, cf. \zvref{sec-repart-du-memo}.}, situés (ainsi que
...
Les \zvref{sec-canevas,sec-specimens} détaillent les fichiers qui constituent
...
% complète de la thèse (cf. \zvref{sec-autom-des-comp} pour plus de détails).

% Les \zvref{sec-specimens,sec-canevas} détaillent davantage ces spécimens et
...
% processus de compilation complète de la thèse (cf. \zvref{sec-autom-des-comp}
