\newcommand{\frenchabstract}{%
  ...
  \item \package{glossaries-extra} pour les glossaire, liste d'acronymes et liste
    de symboles.
  \end{itemize}
  %
...
\begin{abstract}
  ...
  \item \package{glossaries-extra} for the glossary, list of acronyms and list of symbols.
  \end{itemize}
