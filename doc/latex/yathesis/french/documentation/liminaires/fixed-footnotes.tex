\DeclareFixedFootnote{\latexmkrc}{%
  ...
  (cf. \zvref{sec-autom-des-comp} pour plus de détails).%
}
%
...
\DeclareFixedFootnote{\syntaxeoptions}{%
  Le sens de la syntaxe décrivant les options est explicité \zvref{sec-options}.%
}
%
...
\DeclareFixedFootnote{\selonlangue}{%
  \selonlanguebase{} (cf. \zvref{sec-expressions-cles} pour plus de précisions).%
}%
...
\DeclareFixedFootnote{\redefexprcle}{%
  ...
  \zvref{sec-expressions-standard}.%
}
%
...
%   \zvref{fig-acknowledgements,fig-caution}.%
% }
%
\DeclareFixedFootnote{\nochapter}{%
...
\DeclareFixedFootnote{\fichierconfig}{%
  ...
  décrit \zvref{sec-canevas}, fournit ce dossier et ce fichier.%
}
%
...
\DeclareFixedFootnote{\exceptoneside}{%
  ...
  (cf. \zvref{sec-options-usuelles-de}).%
}
%
\DeclareFixedFootnote{\noframe}{%
  Sans le cadre.%
...
\DeclareFixedFootnote{\detailsspecimencanevas}{%
  Détaillés à l'\zvref{cha-specimen-canevas}.
}
%
...
\DeclareFixedFootnote{\titresnormalalternatif}{%
  \enquote{Normal} ou alternatif, cf. \zvref{sec-intit-altern}.%
}
%
