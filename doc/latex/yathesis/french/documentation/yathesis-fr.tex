...
\makeindex[name=commands,columns=2,title=Index des commandes]
\makeindex[title=Index des concepts,columns=3]
%
...
\AfterEndPreamble{%
  ...
  \changes{v0.99o}{2016-09-29}{Documentation révisée et augmentée d'un index
    des concepts (travail en cours)}%
