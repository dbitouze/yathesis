...
%
\lstset{%
  alsolanguage=[glossaries-extra]TeX,%
...
%
\AtEndPreamble{%
  \changes{v1.0.13}{2026-05-04}{Correction d'inconsistances dans le texte en
    anglais de la clause de non responsabilité}%
  \changes{v1.0.13}{2026-05-04}{Ajout du \emph{Guide du doctorant}}%
  \changes{v1.0.13}{2026-05-04}{Adaptation et passage de \package{glossaries}
    à \package{glossaries-extra}}%
  \changes{v1.0.12}{2024-03-07}{Documentation améliorée}%
  \changes{v1.0.12}{2024-03-07}{Code plus robuste}%
  \changes{v1.0.11}{2023-02-24}{Modifications transparentes pour l'utilisateur
    final}%
...
\indexprologue{%
  ...
  \item valeur de clé ;
  \end{itemize}
  des entrées (selon la convention précisée \zvref{sec-comm-envir-cles}).%
}%
