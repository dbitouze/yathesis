...
\makeindex[name=commands,columns=2,title=Index des commandes,options=-M denisbdoc.xdy -L french]
\makeindex[title=Index des concepts,columns=3,options=-M denisbdoc.xdy -L french]
%
...
\AfterEndPreamble{%
  ...
  \changes{v0.99o}{2016-10-16}{Documentation révisée et augmentée d'un index
    des concepts}%
  \changes{v0.99o}{2016-09-29}{Correction de bugs}%
  \changes{v0.99n}{2016-05-22}{Documentation révisée}%
