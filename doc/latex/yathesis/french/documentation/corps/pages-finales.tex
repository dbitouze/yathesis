...
\zvref{sec-sigl-gloss-nomencl,fig-printglossary}.
...
La \zvref{fig-printindex} illustre une page d'index créé au moyen du
\Package{imakeidx}.
...
finale. Nous renvoyons ici à la \zvref{sec-table-des-matieres} et à la
\zvref{fig-tableofcontents} qui traite déjà cette question.
