...
\changes{v1.0.6}{2021-03-23}{La correction du bug
  ...
  remplacer une section non numérotée par une émulation de celle-ci ; cela peut
  entraîner de légères variations de mise en page}
...
\changes{v1.06}{2021-03-23}{Nouvelle commande \refCom{leadchapter} permettant,
  pour chaque chapitre, de spécifier un texte inséré entre sa tête et son
  éventuelle \gls{tdml} automatique.}%
...
\begin{docCommand}[doc new=2021-03-23]{leadchapter}{\marg{texte}}
  \indexsee{chapeau}{table des matières!locale!texte introductif}%
