...
%
\changes{v0.99o}{2016-10-24}{Nouvelle option de classe \refKey{localtocs}
  permettant de faire automatiquement débuter les chapitres par leurs tables des
  matières locales}%

\begin{docKey}[][doc new=2016-10-24]{localtocs}{}{pas de valeur par défaut, pas
    de valeur initiale} 
...
{%
  ...
  \begin{docKey}[][doc
    new=2016-10-24]{localtocs/depth}{=\docValue{section}\textbar\docValue{subsection}\textbar\docValue{subsubsection}\textbar\docValue{paragraph}\textbar\docValue{subparagraph}}{par
...
%
\changes{v0.99o}{2016-10-24}{Nouvelle option de classe \refKey{localbibs}
  permettant de faire automatiquement finir les chapitres par leurs
  bibliographies locales}%

\begin{docKey}[][doc new=2016-10-24]{localbibs}{}{pas de valeur par défaut, pas
    de valeur initiale} 
...
\label{sec-hdr}%
\index{\acrshort{hdr} (habilitation)}%
...
\begin{docKey}{hdr}{=\docValue{true}\textbar\docValue{false}}{par défaut
  ...
  \indexdef{\acrshort{hdr} (habilitation)}%
