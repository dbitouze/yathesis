...
\emph{produire}, à partir des données définies \zvref{sec-proprietes-de-titre},
...
\begin{docCommand}[doc description=\mandatory]{maketitle}{\oarg{options}}%
  ...
  \item \emph{automatiquement}\footnote{Sans qu'il soit nécessaire de faire
    ...
    (cf. \zvref{rq-titre-supp}). Cette page est composée dans la langue
    secondaire.
  \end{enumerate}
\end{docCommand}
...
Avec les données caractéristiques de l'\zvref{ex-preparation-production-titre},
...
\begin{dbremark}{Expressions clés émaillant les pages de titres}{}
  ...
  \end{itemize}
  que la \yatCl{} insère de façon automatique. La \zvref{sec-expressions-cles}
