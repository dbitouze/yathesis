...
\begin{dbexample}{Production de la page dédiée à la clause de
  ...
  Le résultat de ce code est illustré \zvref{fig-disclaimerpage}.
\end{dbexample}
...
\begin{dbexample}{Préparation et production de la page dédiée aux mots clés}{}
  \indexex{mot clé}%
  Les codes suivants produisent la page illustrée \zvref{fig-makekeywords}.
...
\begin{dbexample}{Préparation et production de la page dédiée au(x) laboratoire(s)}{}
  \indexex{laboratoire}%
  Les codes suivants produisent la page illustrée \zvref{fig-makelaboratory}.
  \NoAutoSpacing%
...
\begin{dbexample}{Préparation et production de la page dédiée aux dédicaces}{}
  ...
  Le résultat de ce code est illustré \zvref{fig-dedicationspage}.
\end{dbexample}
...
\begin{docCommand}{frontepigraph}{\oarg{langue}\marg{épigraphe}\marg{auteur}}
  ...
  \footnote{Si cette \meta{langue} est autre que le français ou l'anglais, elle
    ...
    \docAuxCommand{documentclass} (cf.  \zvref{rq-languessupplementaires}).}.
\end{docCommand}
...
\begin{dbexample}{Préparation et production de la page dédiée aux épigraphes
  ...
  \indexex{épigraphe}%
  \NoAutoSpacing%
  Les codes suivants produisent la page illustrée \zvref{fig-epigraphspage}.
...
avertissement, un résumé substantiel en français (cf. \zvref{wa-frenchabstract}),
...
\begin{dbexample}{Préparation et production de la page dédiée aux résumés}{}
  \indexex{résumé}%
  Les codes suivants produisent la page illustrée \zvref{fig-resumes-succincts}.
...
\Package{glossaries-extra}\footnote{Dans ses versions à partir de la \texttt{4.0} en
...
\begin{dbwarning}{Package \package{glossaries-extra} non chargé par défaut}{}
  Le \Package{glossaries-extra} \emph{n'étant pas} chargé par la \yatCl{}, on veillera
...
%     (cf. \zvref{fig-printglossary}) ;
%   \item \docAuxCommand{printabbreviations}\footnote{L'usage de la commande
%       \docAuxCommand{printabbreviations} nécessite que l'option \docAuxKey{acronyms}
%       soit passée au \Package{glossaries-extra}.} qui produit la liste des
%     acronymes\termesdefinisutilises{} (cf. \zvref{fig-printabbreviations}) ;
%   \end{itemize}
...
\begin{dbwarning}{Option \texttt{symbols} nécessitée par la commande
  ...
  \docAuxKey{symbols} soit passée au \Package{glossaries-extra}.
\end{dbwarning}

\begin{docCommand}{printsymbols}{\oarg{options}}
  \index{symbole!liste de ---s}%
  Cette commande, fournie par le \Package{glossaries-extra}, produit la liste des
...
\begin{dbexample}{Définitions et liste des symboles}{}
  ...
  Le résultat de ce code est illustré \zvref{fig-printsymbols}.
\end{dbexample}
...
des acronymes\footnote{Les commandes \docAuxCommand{printglossary} et
  \docAuxCommand{printabbreviations} du \Package{glossaries-extra}, produisant les listes
  des termes du glossaire et des acronymes, sont illustrées
  \zvref{fig-printglossary,fig-printabbreviations}.} et des symboles sont \emph{a
...
\begin{landscape}
  \begin{figure}[p]
    ...
    \begin{subfigure}[b]{.45\linewidth}
      \centering
      \screenshot[1]{printabbreviations}
      \caption{Acronymes}
      \label{fig-printabbreviations}
    \end{subfigure}%
    \hspace{\stretch{1}}%
    \begin{subfigure}[b]{.45\linewidth}
      \centering
    ...
    \label{fig-printabbreviations-printsymbols}
  \end{figure}
\end{landscape}
% }
...
%   chargera \package{glossaries-extra} \emph{sans} l'option |acronym| et on recourra à
%   la commande \docAuxCommand{printglossary} ;
% \item deux listes \emph{distinctes}, on chargera \package{glossaries-extra}
%   \emph{avec} l'option |acronym|. et on recourra à la commande
%   \begin{enumerate}
%   \item \refCom{printabbreviations} pour celle des acronymes (cf.
%     \zvref{fig-acronymes}) ;
%   \item\label{item:1} \docAuxCommand{printglossary} pour celle des termes du
%     glossaire (cf. \zvref{fig-printglossary}).
%   \end{enumerate}
% \end{enumerate}
...
création des tables des matières \enquote{globales}\footnote{Par opposition aux
  ...
  cf. \zvref{sec-localtoc}.} pour permettre de facilement
\begin{itemize}
...
\begin{dbexample}{Sommaire et table des matières}{sommaire-table-des-matieres}
  ...
  %
  La \zvref{fig-tableofcontentsto-tableofcontents} illustre ce code.
\end{dbexample}
