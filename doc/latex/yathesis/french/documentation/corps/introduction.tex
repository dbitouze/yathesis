...
\begin{enumerate}
\item en page(s) de titre (cf. \zvref{cha-caract-du-docum,cha-pages-de-titre}) ;
\item en \gls{liminaire} (cf. \zvref{cha-liminaires}) ;
\item en partie principale (corps) de la thèse (cf. \zvref{cha-corps}) ;
\item en annexes (cf. \zvref{cha-annexes}) ;
\item en partie finale (cf. \zvref{cha-pages-finales}).
\end{enumerate}
Elle indique enfin comment personnaliser la \yatCl{}
(cf. \zvref{cha-configuration}).
...
L'installation de la \yatCl{} est décrite à l'\zvref{cha-installation}.

L'\zvref{cha-specimen-canevas} est dédiée à deux spécimens et deux canevas de
...
L'\zvref{cha-recomm-et-astuc} fournit quelques recommandations, trucs et astuces.

Les questions fréquemment posées au sujet de la \yatCl{} sont répertoriées
à l'\zvref{cha-faq}.

L'\zvref{cha-fichiers-importes-par} documente deux fichiers que la \yatCl{}
importe automatiquement.

L'\zvref{cha-packages-charges} répertorie les packages chargés par la \yatCl{} et
...
L'\zvref{cha-incomp-conn} liste les incompatibilités connues de la \yatCl{}.

Si nécessaire, on pourra consulter l'\zvref{cha-pagination} pour avoir une vue
...
à l'\zvref{cha-synt-term-notat}. De même, certains des termes employés ici sont
définis dans le glossaire \vpageref{glossaire}.

L'\zvref{cha-add-ons} signale quelques \emph{add-ons} destinés à faciliter
l'usage de la \yatCl{} avec différents éditeurs de texte.

L'\zvref{cha-usage-avance}, à ne pas mettre entre toutes les mains, indique
...
L'\zvref{cha-comp-de-la-pres} détaille la procédure permettant de compiler
soi-même la présente documentation.

L'\zvref{cha-trad-de-la-pres} aborde la question de la traduction de la présente
documentation en langues étrangères, notamment en anglais.

L'\zvref{cha-devel-futurs} est une \emph{TODO list} des fonctionnalités que
l'auteur de \yatcl{} doit encore mettre en œuvre, que ce soit pour la classe
elle-même ou pour sa documentation.

Enfin, l'historique des changements de la classe se trouve \zvref{cha-history}.
...
Talbot pour \package{datatool} et \package{glossaries-extra}, Thomas F. Sturm
