...
\begin{landscape}
  \begin{figure}[htb]
    ...
    \begin{subfigure}[b]{.45\linewidth}
      \centering%
      \fbox{\includegraphics[page=1,width=\linewidth-2\fboxsep-2\fboxrule]{specimens/en-arborescence/these}}
    ...
    \begin{subfigure}[b]{.45\linewidth}
      \centering%
      \fbox{\includegraphics[page=5,width=\linewidth-2\fboxsep-2\fboxrule]{specimens/en-arborescence/these}}
